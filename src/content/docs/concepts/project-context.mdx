...
| A scenario illustrates a spec | `scenario depends_on spec` |
| A scenario realizes an intended user path | `scenario implements journey` |
| A user path belongs to product requirements | `journey related prd` |
