...
- The [Archcore CLI](/cli/overview/) is the core: one binary, 10 core MCP tools plus `install_host_config` for host wiring, and lifecycle hooks that work with all eight supported agents.
