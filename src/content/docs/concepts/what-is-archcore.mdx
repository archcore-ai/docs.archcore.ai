...
- The [Archcore plugin](/plugin/overview/) runs in Claude Code, Cursor, and Codex CLI. It adds 7 outcome-focused slash commands, built-in agents, and guardrails.
- The [Archcore CLI](/cli/overview/) is the core: one binary, 10 MCP tools, and session hooks that work with all eight supported agents.
