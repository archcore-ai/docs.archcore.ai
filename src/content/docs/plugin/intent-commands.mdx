...
description: The 8 Archcore Plugin intent commands — /archcore:capture, plan, decide, standard, review, status, actualize, help. Describe what you want and the skill routes to the right type or flow.
---
