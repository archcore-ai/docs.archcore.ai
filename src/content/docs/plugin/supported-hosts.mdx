...
The plugin is not available on GitHub Copilot yet, or on any other MCP-aware CLI without a plugin runtime. Those agents work via the [CLI path](/cli/overview/) only — MCP access and agent integrations, but no plugin skills or guided flows.
