...
| Host                   | Status       | Install from the host                 | Install with the Archcore CLI                          | MCP wiring                                                                        | Hook events                                             |
| ---------------------- | ------------ | ------------------------------------- | -------------------------------------------------------- | ----------------------------------------------------------------------------------- | --------------------------------------------------------- |
...
- [Install the plugin](/plugin/install/) covers `archcore plugin install` and the marketplace command for each host.
