...
- [`/archcore:review`](/plugin/skills/#archcorereview) — audit docs by category, type, or tag.
- [`/archcore:actualize`](/plugin/skills/#archcoreactualize) — find stale documents.
- [`/archcore:status`](/plugin/skills/#archcorestatus) — some of the dashboard numbers come from auditor queries.
