...
- [ISO track](/plugin/tracks/) — building the full BRS → StRS → SyRS → SRS cascade.
- [Architecture track](/plugin/tracks/) — wiring ADR → spec → plan with the right relations.
...
- [`/archcore:review`](/plugin/intent-commands/) — audit docs by category, type, or tag.
- [`/archcore:actualize`](/plugin/intent-commands/) — find stale documents.
- [`/archcore:status`](/plugin/intent-commands/) — some of the dashboard numbers come from auditor queries.
...
- [Intent commands](/plugin/intent-commands/) — the user-facing commands that call these agents.
- [Tracks](/plugin/tracks/) — multi-step flows that use `archcore-assistant`.
