...
| Flag               | Description                                                                                                                                              |
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--agent <id>`     | Non-interactive: initialize and install hooks, MCP config, and the usage hint for the given agent id (e.g. `claude-code`, `cursor`, `codex-cli`, `copilot`). Repeatable. |
