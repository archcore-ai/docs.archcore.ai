...
- An index of every document in `.archcore/`, grouped by category (knowledge, vision, experience), listing each document's filename and title.
- A summary of relations (which documents reference which).
- Top tags currently used across documents (up to 20).
