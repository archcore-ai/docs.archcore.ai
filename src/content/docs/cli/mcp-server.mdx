---
title: MCP Server
description: How the Archcore MCP server connects AI coding agents to .archcore/, the 8 tools it exposes, and how session hooks inject context at the start of every conversation.
---
