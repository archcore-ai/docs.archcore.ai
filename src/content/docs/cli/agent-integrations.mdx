...
Two of these hosts (Claude Code and Cursor) additionally support the higher-level **Archcore Plugin** — skills, tracks, built-in agents, and guardrails. See [Plugin supported hosts](/plugin/supported-hosts/) for the plugin-specific matrix.
