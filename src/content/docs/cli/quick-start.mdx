...
>
	Want skills like `/archcore:adr` and multi-step tracks without explaining them to the agent each time?
</CrossLinkCallout>

## Next steps

- [Commands](/cli/commands/) — every `archcore` subcommand in one reference.
- [MCP server](/cli/mcp-server/) — the 8 tools your agent can call, and how the server is started.
