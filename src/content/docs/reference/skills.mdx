...
description: Lookup table for the 7 Archcore plugin commands with flags, plan track flows, decide continuations, and audit modes.
---
...
| ---------- | ------------------------------------- | ---------------------------------------------------------------------------- | -------------------------------------------------------------- |
| `product`  | idea → prd → plan                     | `prd implements idea`, `plan implements prd`                                 | Lightweight product flow for individual features.               |
...
| `sources`  | mrd → brd → urd                       | `brd related mrd`, `urd related mrd, brd`                                    | Discovery across market, business, and user research.           |
...
| `/archcore:audit --drift`     | Staleness scan      | Code drift, cascade drift, and temporal drift: documents that have gone out of date. |
