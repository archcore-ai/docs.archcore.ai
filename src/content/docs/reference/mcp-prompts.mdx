...
Use plugin cascades when you're on a plugin host and want the outcome-focused command experience. Use MCP prompts when you're on a host the plugin doesn't support yet, or when you want a host-agnostic way to drive cascades.
