...
- Using **Claude Code, Cursor, Codex CLI, or GitHub Copilot CLI**? Start with the [Plugin](/plugin/overview/). You get skills, guided plan flows, built-in agents, and guardrails. (Codex CLI also has a CLI-only fallback if you'd rather not enable Codex's `hooks` feature.)
